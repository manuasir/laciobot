  ...
  bot.on([/^\/contactos (.+)$/], async (msg,props) => {
    try {
      ...
      if(contacts.length<1)
        msg.reply.text('⌨ No hay contactos de '+what+' todavía, puedes añadir con el comando /nuevocontacto [nombre]+[telefono]+[cosas]. '+"\n"+'Ej: /nuevocontacto tatin 612487956 lacasitos')
      else{
        let str = "";
